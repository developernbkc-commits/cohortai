...
import { ArrowRight, Sparkles, ShieldCheck, Users, Workflow, Database, Wallet, UserCog } from "lucide-react";
      ...
      <section className="py-14 border-t border-slate-800/60">
        <Container>
          <SectionTitle
            ...
            title="Ready for registrations, UPI payments, and admin operations"
            desc="We refreshed the website direction so it can evolve into an enrollment platform rather than staying a brochure-only site."
          />
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {platformCards.map((card) => (
              <div key={card.title} className="glass rounded-3xl p-6 ring-soft">
                <card.icon className="text-cyan-200" size={20} />
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Button href="/admin" variant="secondary">View admin console</Button>
          </div>
        </Container>
      </section>
