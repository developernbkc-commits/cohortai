  ...
  return (
    <div>
      <section className="pt-12 pb-10">
        <Container>
          <SectionTitle eyebrow="Contact" title="Get a batch schedule + recommended starting level" desc="Fill the form and we’ll contact you. Or WhatsApp / call for faster help." />
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            <Button href={`https://wa.me/91${site.whatsapp}`} target="_blank" rel="noreferrer">WhatsApp +91 {site.whatsapp}</Button>
            <Button href={`tel:${site.phone}`} variant="secondary">Call {site.phone}</Button>
          </div>
        </Container>
      </section>
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
            ...
            <form name="lead" method="POST" data-netlify="true" netlify-honeypot="bot-field" action="/thanks" className="card card-3d rounded-3xl p-6">
              ...
              <div className="grid gap-4">
                ...
                <div className="text-xs text-slate-500">By submitting, you agree to be contacted by CohortAI Labs. We respect your privacy.</div>
              </div>
            </form>
          </div>
        </Container>
