  ...
  return (
    <div>
      <section className="pt-12 pb-10">
        <Container>
          <SectionTitle eyebrow="Courses" title="A premium ladder from starter to flagship cohort" desc={`Batches start ${site.startDate}. Choose a track and a level based on your goals.`} />
