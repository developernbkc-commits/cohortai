      ...
      <div className="bg-white/80 backdrop-blur-xl border-b border-slate-200/70">
        <Container>
          <div className="h-[86px] flex items-center justify-between gap-4">
            ...
            <nav className="hidden lg:flex items-center gap-6 text-sm">
              {nav.map((n) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    cn(
                      "relative text-slate-700 hover:text-slate-950 transition",
            ...
            <button
              className="lg:hidden inline-flex items-center justify-center rounded-xl p-3 text-slate-700 hover:bg-slate-100"
              onClick={() => setOpen((v) => !v)}
